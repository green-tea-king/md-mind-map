...
- 心智圖節點編輯、拖曳、排序、收合
- 右鍵選單、指令面板、搜尋與定位
- Markdown 標題、清單、引用、表格、程式碼、警示框、腳註；清單操作使用切換語意，圖示操作分開加圖示與清除，分隔線操作明確標示節點上方/下方，警示框與跳脫符號可由節點右鍵文字格式套用
...
```powershell
& "W:\4. TODO (這裡是公用區 特定電腦勿放)\MD心智圖\deploy.ps1" -Message "Deploy v10.63"
```
